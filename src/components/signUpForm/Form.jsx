...
import enData from "../../utils/locales/en/signup_email.json";
import ruData from "../../utils/locales/ru/signup_email.json";
import trData from "../../utils/locales/tr/signup_email.json";

export default function Form({ submit, name, setName, surname, setSurname, email, setEmail, password, setPassword, language }) {
    ...
    return (
        <form onSubmit={submit}>
            ...
            <br />
            <span className='sign-mobile'>{translation.paragraph}&nbsp;<RegisterLink><Link to={`/signup-mobile/${language}`}>{translation.option}</Link></RegisterLink></span><br />
